...
const Header = () => {
                ...
                <div className="flex items-center justify-between w-full">
                    ...
                    <div className="hidden lg:flex flex-1 max-w-md xl:max-w-xl mx-4 xl:mx-6">
                        <SearchInput
                            ...
                            rounded-sm text-white placeholder-neutral-500 text-sm
                            focus:outline-none focus:ring-0.5 focus:ring-indigo-700/60 focus:border-indigo-700/60
                    ...
                    {showMobileSearch && (
                        <div className="lg:hidden flex-1 mx-2">
                            <SearchInput
                                className="block w-full pl-10 pr-4 py-2 
                                bg-neutral-800/70 backdrop-blur-sm border border-neutral-700/60 
                                rounded-xs text-white placeholder-neutral-500 text-sm
  ...
  rounded-lg  bg-zinc-900/80 backdrop-blur-sm
  ...
  text-xs sm:text-sm font-medium text-zinc-200 
  hover:text-white "
                                >
                                ...
                                bg-neutral-800/70 backdrop-blur-sm hover:bg-indigo-800/70 border border-neutral-700/60 
                                text-white text-xs sm:text-sm font-medium rounded-sm transition-colors ${showMobileSearch ? 'lg:hidden' : ''
                                        }`}
                                >
                                    <Plus className="w-3 h-3 sm:w-4 sm:h-4 rotate-on-hover" />
                                ...
                                <div className="relative" ref={profileMenuRef}>
                                    ...
                                    {showProfileMenu && (
                                        <div className="absolute right-0 mt-2 w-48 bg-neutral-900/95 backdrop-blur-xl backdrop-saturate-150 border-2 border-neutral-800 rounded-sm shadow-xl z-50 overflow-hidden">
                                            {/* User Info */}
                            ...
                            <>
                                <button
                                    ...
                                    className={`px-2 smooch-sans py-1.5 sm:px-3 sm:py-2 lg:px-4 text-xs sm:text-sm font-medium text-neutral-300 hover:text-white rounded-sm hover:bg-neutral-800/70 backdrop-blur-sm transition-colors ${showMobileSearch ? 'hidden sm:block' : ''
                                        }`}
                                >
                                    Sign in
                                </button>
                                <button
                                    ...
                                    className={`px-2 py-1.5 sm:px-3 smooch-sans sm:py-2 lg:px-4 bg-indigo-900 backdrop-blur-sm hover:bg-indigo-800 text-white text-xs sm:text-sm font-medium rounded-sm transition-colors ${showMobileSearch ? 'hidden sm:block' : ''
                                        }`}
                                >
                                    Sign up
                                </button>
