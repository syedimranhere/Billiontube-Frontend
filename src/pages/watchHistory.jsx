...
const WatchHistory = () => {
    ...
    return (
        <div className="min-h-screen bg-black text-white pt-14 sm:pt-16">
            {/* Clear History Modal */}
            {showClearModal && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-xs flex items-center justify-center z-10 p-4">
                    <div className="bg-black/60 rounded-sm border border-neutral-800 p-4 sm:p-6 max-w-sm sm:max-w-md w-full">
                        {/* Header */}
                        <div className="flex items-center gap-3 mb-4">
                            <div className="w-8 h-8 bg-red-600/20 rounded-sm flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            <button
                                ...
                                className="flex-1 px-4 py-2 transition-colors text-neutral-300 hover:text-white bg-neutral-600 hover:bg-neutral-800  rounded-xs transition-colorstext-sm disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                Cancel
                            </button>
                            <button
                                ...
                                disabled={clearingHistory}
                                className="flex-1 px-4 py-2 bg-red-600 hover:border text-white rounded-sm transition-colors font-medium text-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                            >
                                {clearingHistory ? (
                                    <>
            ...
            {/* Header */}
            <div className="px-2 sm:px-3 md:px-4 py-2 sm:py-2 ">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    ...
                    {watchHistory.length > 0 && (
                        <button
                            ...
                            className="flex items-center gap-2 px-3 py-2 bg-neutral-900 hover:bg-indigo-800/50 text-white rounded-sm transition-colors border border-neutral-900 text-sm"
                        >
